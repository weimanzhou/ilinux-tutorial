...
_PROTOTYPE(void level0, (ilinux_syscall_t level0_func));
_PROTOTYPE(void print_graph, (char *garph));
...
/*************************************************************************
	> keyboard.c
**************************************************************************/
_PROTOTYPE( void init_keyboard, (void) );
