/*************************************************************************
	...
	> Created Time: Fri 05 Feb 2021 05:09:41 PM CST
	...
	> “#ifdef _ILINUX”中,提供了POSIX并不包含的扩展部分。其中有些扩展的意义是很明显的。
	...
	> # ifdef _ILINUX
	> 如果 _ILINUX 未被定义,编译器将根本不会感知到FLYANX扩展。
 ************************************************************************/

#ifndef ILINUX_TERMIOS_H
#define ILINUX_TERMIOS_H

typedef unsigned short  tcflag_t;
typedef unsigned char   cc_t;
typedef unsigned int    speed_t;

#define NCCS		20		// size of cc_c array, some extra space or extensions. 
