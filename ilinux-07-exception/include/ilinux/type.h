/*************************************************************************
	...
	> Created Time: Fri 05 Feb 2021 03:20:27 PM CST
 ************************************************************************/

#ifndef _ILINUX_TYPE_H
#define _ILINUX_TYPE_H

#ifndef _ILINUX_TYPES_H
#include <sys/types.h>
#endif


/* 虚拟内存块，一个块在INTEL的 ilinux 中是256个字节 */
typedef unsigned int vir_clicks;
/* 物理地址（字节） */
typedef unsigned long phys_bytes;
/* 物理内存块，一个块在INTEL的 ilinux 中是256个字节 */
...
/* 消息，ilinux 中的进程通信的根本，同时也是客户端和服务端通信的根本
 * 此数据结构来源自MINIX
 */
