/*************************************************************************
	...
	> POSIX要求include/ 目录下必须有一个assert.h 文件。那么为什么此处有另一个版本呢?
	> 答案是当用户进程出错时,可以依靠操作系统提供某些服务,比如在控制台上打印一条消息。
	> 但如果核心本身出错,则正常的系统资源就未必靠得住。
	> 于是核心提供其自己的例程来处理assert并打印消息,它独立于通常的系统库中的版本。
 ************************************************************************/
