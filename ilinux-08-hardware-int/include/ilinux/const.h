/*************************************************************************
	...
	> Created Time: Fri 05 Feb 2021 02:46:22 PM CST
	> 
	> 系统级别的常量，在多个地方被使用到
 ************************************************************************/
...
/* PRIVATE 是static的同义词，带上它的变量或函数将只在它所在文件中可见，所以 可称为私有 */
#define PRIVATE			static	/* PUBLIC is the opposite of PRIVATE */
/* PUBLIC 表示公有，可以被其它文件所看到 */
#define PUBLIC				
